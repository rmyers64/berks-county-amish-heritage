...
With the base editor we can add [links](/docs), **bold**, *italic* and ~~strikethrough~~ formatting.
...
<imageEmbed image={{ src: "/img/rico-replacement.jpg", alt: "A llama portrait used as an example image", width: 1408, height: 768 }} caption="This is an example llama" />

...
1. A TinaCloud project set up (see [Configuring TinaCloud](/docs/going-live/tinacloud/configuring-tinacloud))
...
<imageEmbed image={{ src: "/img/docs-assets/vercel-build-settings.png", alt: "Vercel build settings configuration for a Next.js project with TinaCMS", width: 1608, height: 1140 }} caption="Vercel Build Settings" />
...
For more details, visit the [official TinaCMS deployment documentation](https://tina.io/docs/tinacloud/deployment-options/vercel).

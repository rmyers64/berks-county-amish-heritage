...
**If using GitHub, we recommend going with TinaCloud**. To read more about TinaCloud, see the [TinaCMS setup documentation](https://tina.io/docs/setup-overview).
...
> **Important**: These environment variables must also be set in your deployment workflow. See our [deployment guide](/docs/going-live/deploying-your-docs) for more information.

...
1. Go to the `/admin` route of your website
...
<imageEmbed image={{ src: "/img/docs-assets/collections-menu-access.png", alt: "TinaCMS sidebar showing the collections menu with a list of documentation pages", width: 2245, height: 1587 }} caption="Accessing a specific page via the collections menu" />
...
<imageEmbed image={{ src: "/img/docs-assets/edit-route-navigation.png", alt: "Browser URL bar showing how to navigate to the edit route by inserting /admin/#/~/ into the URL", width: 2061, height: 1059 }} caption="Going to the edit route on a particular URL" />
...
<imageEmbed image={{ src: "/img/docs-assets/add-new-page-collections.png", alt: "TinaCMS collections menu with the Add File button to create a new documentation page", width: 2245, height: 1587 }} caption="Adding a new page via the collections menu" />
...
<imageEmbed image={{ src: "/img/docs-assets/navigation-new-tab.png", alt: "TinaCMS Navigation Bar collection editor showing how to add a new Docs or API tab", width: 1828, height: 1231 }} caption="Adding a new tab via the Navigation Bar collection" />
...
<imageEmbed image={{ src: "/img/docs-assets/menu-tree-structure.png", alt: "TinaCMS Navigation Bar editor showing the nested tree structure of menu items and sub-menus", width: 2245, height: 1587 }} caption="Inside the Tab object exists your menu tree structure" />
